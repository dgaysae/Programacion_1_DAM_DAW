...
public class Main03Provider {
    public static void main(String[] args) {
        List<Integer> naturales = getLista(20, new IntegerProvider() {
        ...
        List<Integer> multiplosDe3 = getLista(20, new IntegerProvider() {
        ...
        List<Integer> aleatoriosMenoresDe100 = getLista(20, new IntegerProvider() {
            @Override
            public Integer get() {
